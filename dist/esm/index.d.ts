...
declare const GuidoFactoryAdapter: {
...
export declare class Note implements INote, IClonable<Note> {
	...
	become(p1?: EnumNote | INote | string | number, p2?: number | string): this;
	...
	protected fromOffsetAndTonality(offsetIn: number, tonalityIn?: string): this;
...
export declare class Pitch extends Note implements IPitch, IClonable<Pitch> {
	...
	become(p1?: IPitch | EnumNote | INote | string | number, p2?: number | string): this;
