...
export declare type $ARHandler = number;
export declare type $GRHandler = number;
export declare type $GuidoParser = number;
export declare type $GuidoStream = number;
export declare type $PianoRoll = number;
